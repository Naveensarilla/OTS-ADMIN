...
const NewExamUpdataion = () => {
  ...
  return (
    <div className="examUpdate_container">
      <h2 style={{color:'#1A374D'}}> Exam Updataion</h2>
      <form onSubmit={handleSubmit}>
        <div className="examTDD">
          <div className="examUp_Contant">
        ...
        <div className="exam_Subjects">
          <label style={{textTransform:'uppercase'}} className="examUpsu">Subjects:</label>
          {subjects.map((subject) => (
            <div key={subject.subjectId} className="examCh_Contant">
       ...
       <div style={{float:'right'}} className="examUp_Submit">
